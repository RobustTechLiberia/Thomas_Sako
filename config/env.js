...
export const env = {
  ...
  db: {
    ...
    // CA certificate as an inline PEM string (e.g. Aiven's ca.pem pasted
    // into a platform env var — the ONLY practical option on serverless).
    sslCa: required("DB_SSL_CA", ""),
    // Alternative: path to a PEM CA bundle on the disk (containers/VMs).
