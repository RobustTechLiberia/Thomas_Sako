...
class AboutContent extends React.Component {
  render() {
    return (
      <>
        <div className="bg-gradient-to-b from-[#253C6D] to-[#253C6D] gap-5 md:gap-10 lg:gap-10 h-200 md:h-196 lg:h-196 mt-5 mb-5 md:mt-8 lg:mt-8 mx-2 md:mx-10 lg:mx-10">
